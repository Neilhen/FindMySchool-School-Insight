...
const CARTO_KEY = 'cb1_2g3f_1_4aa7b5e61a8c427fbd78ee9a';

const cartoLight = CARTO_KEY ? L.tileLayer(
  'https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png?key=' + CARTO_KEY, {
  attribution: '&copy; OpenStreetMap contributors &copy; CARTO',
  subdomains: 'abcd', maxZoom: 19,
  // {r} in the URL above is Leaflet's retina placeholder, and it only ever
  // resolves to "@2x" when this is on -- without it the template silently
  // filled in an empty string and every Mac and phone got a soft basemap.
  // It does not double the request count: Leaflet fetches @2x tiles one zoom
  // level down, so the number of tiles is about the same.
  detectRetina: true
}) : null;

// The same key is also used by schools/homepage-map.js, which is generated by
// build_school_pages.py. If it changes, change it in both.
